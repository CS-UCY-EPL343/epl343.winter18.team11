                            ...
                            <label>Subtotal</label>
                              ...
                              <div id="product_id" class="product">
                                  ...
                                  <div class="product_details">
                                    <div class="product_category">Category 20</div>
                                  </div>
                                  ...
                                  <div class="product_removal">
                                    <button class="remove_product" onclick="remove_fun()">
                                      Remove
                                    </button>
                                  </div>
  
                                  <div class="product_total">10</div>
                                ...
                                <div id="product_id" class="product">
                                    ...
                                    <div class="product_details">
                                      <div class="product_category">Category 30</div>
                                    </div>
                                 ...
                                 <form method="post" action="database.php">
                                   ...
                                   <input type="text" name="number" value='.$pr.' />
                                  ...
                                  <div class="product_removal">
                                    ...
                                    <div class="product_total">25.98</div>
